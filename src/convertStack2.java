...
public class convertStack2 {
    private Stack <convertStack> dataPerpus;
    public static void main(String[] args) throws Exception{
        convertStack2 Screen = new convertStack2();
        Screen.inputData();
        Screen.cetakData();
    }
    public void inputData() {
        dataPerpus = new Stack<convertStack>();
        String jawaban;
        int number = 1;
        do {
            ...
            convertStack perpus = new convertStack(judul, pengarang, penerbit, tahun, kategori);
